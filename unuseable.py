...
progressbar1, progressbar2 = ttk.Progressbar(left_frame, orient='horizontal', value=0, length=200,mode='determinate'),ttk.Progressbar(left_frame,orient='horizontal',value=0,length=200,mode='indeterminate')
